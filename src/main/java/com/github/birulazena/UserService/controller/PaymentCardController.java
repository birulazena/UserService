...
public class PaymentCardController {
    ...
    @PostAuthorize("returnObject.body.userId == authentication.details['userId'] or hasRole('ADMIN')")
    @GetMapping("/{id}")
    ...
    @PreAuthorize("@userSecurity.belongsToUser(authentication.details['userId'], #id) or hasRole('ADMIN')")
    @PutMapping("/{id}")
