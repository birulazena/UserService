...
public class PaymentCardServiceUnitTests {
    ...
    void updateCardByIdTest() {
        ...
        Mockito.when(cacheManager.getCache("user_cache")).thenReturn(Mockito.mock(Cache.class));
    ...
    void activateCardByIdWithFalseTest() {
        ...
        Mockito.verify(paymentCardRepository).updateActivate(1L, true);
    }
    ...
    void activateCardByIdWithTrueTest() {
        ...
        Mockito.verify(paymentCardRepository, Mockito.never()).updateActivate(Mockito.anyLong(), Mockito.anyBoolean());
    }
    ...
    void deactivateCardByIdWithTrueTest() {
        ...
        Mockito.verify(paymentCardRepository).updateActivate(1L, false);
    }
    ...
    void deleteCardById() {
        ...
        paymentCardService.deleteCardById(1L);

        Mockito.verify(paymentCardRepository).deleteById(1L);
    }
