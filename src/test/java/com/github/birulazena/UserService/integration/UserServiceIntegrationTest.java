...
public class UserServiceIntegrationTest {
    ...
    void updateUserTest() {
        ...
        OnlyUserResponseDto onlyUserResponseDto = userService.updateUser(id, userRequestDto);

        assertEquals(id, onlyUserResponseDto.id());
        assertEquals(userRequestDto.email(), onlyUserResponseDto.email());
        assertNotNull(cacheManager.getCache("user_cache").get(id));
    }
